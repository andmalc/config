# Run command:
# ipython3 notebook --no-browser --ip=0.0.0.0 --profile=andmalc
#
...
c.NotebookApp.notebook_dir = '/home/andmalc/work/ipython-notebooks'
...
c.NotebookApp.password =  'sha1:96cd5e41a5de:6e638920c1ed3deccee9ff1dba13eb85df2435af'
...
# c.InlineBackend.rc = {'figure.figsize': (6.0, 4.0), 'figure.facecolor': (1, 1, 1, 0), 'figure.edgecolor': (1, 1, 1, 0), 'font.size': 10, 'figure.subplot.bottom': 0.125, 'savefig.dpi': 72}
...
# 
# c.MappingKernelManager.root_dir = '/home/andmalc/.ipython'
...
# 
# c.FileNotebookManager.notebook_dir = '/home/andmalc/.ipython'
