...
# a config file.
# 
# - ipython2python - strip_dollars - highlight2latex - add_anchor - indent -
# markdown2html - strip_ansi - add_prompts - path2url - citation2latex -
# escape_latex - get_lines - posix_path - markdown2latex - highlight2html -
# ansi2latex - wrap_text - strip_files_prefix - comment_lines - ansi2html -
# ascii_only - filter_data_type - markdown2rst - html2text
...
# 
# c.ExtractOutputPreprocessor.extract_output_types = {'png', 'application/pdf', 'jpeg', 'svg'}
